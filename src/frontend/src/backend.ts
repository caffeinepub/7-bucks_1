...
import type { Transaction as _Transaction, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createOrUpdateApiCredentials(arg0: string, arg1: string, arg2: boolean | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createOrUpdateApiCredentials(arg0, arg1, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async orchestratePayment(arg0: string, arg1: bigint, arg2: string): Promise<Transaction> {
        if (this.processError) {
            try {
                const result = await this.actor.orchestratePayment(arg0, arg1, arg2);
...
function from_candid_record_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        contiPayReference: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.contiPayReference)),
        totalCharged: value.totalCharged,
        contiPayError: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.contiPayError)),
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? Variant_pending_success_failed.pending : "success" in value ? Variant_pending_success_failed.success : "failed" in value ? Variant_pending_success_failed.failed : value;
}
function from_candid_vec_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Transaction>): Array<Transaction> {
